    ...
    Editor.prototype = /**@lends baidu.editor.Editor.prototype*/{
        ...
        _setup: function ( doc ) {
            ...
            if ( ie ) {
                ...
                doc.attachEvent("onclick",function(){if (window['listen_ueditor_iframe_click']) window.listen_ueditor_iframe_click();})
            } else {
                doc.body.contentEditable = true;
                doc.body.spellcheck = false;
                doc.addEventListener("click",function(){if (window['listen_ueditor_iframe_click']) window.listen_ueditor_iframe_click();},false)
            }
            ...
            if(me.options.focus){
                setTimeout(function(){
                    //crane me.selection.getRange().setStartBefore(me.body.firstChild).setCursor(false,true);
                    try {
